...
/* ---------- 영어: 문장 문제 (학년제 1~10단계, 각 20개, 총 200문항)
   1~5단계(초1~중1)=빈칸 채우기(fill), 6~10단계(중2~고3)=문장 뜻 고르기(meaning) */
var ENGLISH_SENTENCES = {
  1: [
    { type: "fill", sentence: "I have a ___ .", answer: "cat", choices: ["cat","run","big","the"] },
    { type: "fill", sentence: "The ___ is hot.", answer: "sun", choices: ["sun","box","pen","hat"] },
    { type: "fill", sentence: "I can ___ .", answer: "jump", choices: ["jump","blue","milk","door"] },
    { type: "fill", sentence: "This is my ___ .", answer: "mom", choices: ["mom","sit","red","up"] },
    { type: "fill", sentence: "A dog can ___ .", answer: "run", choices: ["run","cup","desk","apple"] },
    { type: "fill", sentence: "I like ___ .", answer: "milk", choices: ["milk","tall","open","she"] },
    { type: "fill", sentence: "The sky is ___ .", answer: "blue", choices: ["blue","fish","book","walk"] },
    { type: "fill", sentence: "I see a ___ .", answer: "bird", choices: ["bird","eat","cold","yes"] },
    { type: "fill", sentence: "My ___ is red.", answer: "ball", choices: ["ball","swim","warm","go"] },
    { type: "fill", sentence: "I am a ___ .", answer: "boy", choices: ["boy","big","fly","new"] },
    { type: "fill", sentence: "The cat is ___ .", answer: "small", choices: ["small","play","hand","one"] },
    { type: "fill", sentence: "I can ___ a book.", answer: "read", choices: ["read","tree","nice","two"] },
    { type: "fill", sentence: "We ___ at school.", answer: "play", choices: ["play","moon","soft","he"] },
    { type: "fill", sentence: "The ___ is big.", answer: "tree", choices: ["tree","sad","fast","it"] },
    { type: "fill", sentence: "I eat an ___ .", answer: "apple", choices: ["apple","sing","hot","we"] },
    { type: "fill", sentence: "A fish can ___ .", answer: "swim", choices: ["swim","cake","good","my"] },
    { type: "fill", sentence: "My hat is ___ .", answer: "yellow", choices: ["yellow","fork","clap","us"] },
    { type: "fill", sentence: "The baby can ___ .", answer: "cry", choices: ["cry","desk","warm","on"] },
    { type: "fill", sentence: "I have two ___ .", answer: "hands", choices: ["hands","sing","cold","in"] },
    { type: "fill", sentence: "The moon is ___ .", answer: "white", choices: ["white","cup","talk","at"] }
  ],
  2: [
    { type: "fill", sentence: "My sister goes to ___ every day.", answer: "school", choices: ["school","water","happy","under"] },
    { type: "fill", sentence: "We play soccer in the ___ .", answer: "park", choices: ["park","milk","read","cold"] },
    { type: "fill", sentence: "I ___ my teeth every morning.", answer: "brush", choices: ["brush","chair","green","seven"] },
    { type: "fill", sentence: "The bird can ___ in the sky.", answer: "fly", choices: ["fly","cup","warm","desk"] },
    { type: "fill", sentence: "My favorite color is ___ .", answer: "green", choices: ["green","jump","door","many"] },
    { type: "fill", sentence: "I drink ___ when I am thirsty.", answer: "water", choices: ["water","open","tall","fast"] },
    { type: "fill", sentence: "We eat lunch at ___ o'clock.", answer: "twelve", choices: ["twelve","apple","happy","clean"] },
    { type: "fill", sentence: "My dad reads a book every ___ .", answer: "night", choices: ["night","shoe","warm","sing"] },
    { type: "fill", sentence: "The rabbit has long ___ .", answer: "ears", choices: ["ears","play","cold","open"] },
    { type: "fill", sentence: "I feel ___ when I see my friends.", answer: "happy", choices: ["happy","desk","water","seven"] },
    { type: "fill", sentence: "We wear a coat when it is ___ .", answer: "cold", choices: ["cold","read","jump","door"] },
    { type: "fill", sentence: "My mom cooks in the ___ .", answer: "kitchen", choices: ["kitchen","summer","yellow","pencil"] },
    { type: "fill", sentence: "I write with a ___ .", answer: "pencil", choices: ["pencil","happy","fast","warm"] },
    { type: "fill", sentence: "The flowers are ___ in spring.", answer: "pretty", choices: ["pretty","water","seven","chair"] },
    { type: "fill", sentence: "We sleep at ___ .", answer: "night", choices: ["night","green","apple","clean"] },
    { type: "fill", sentence: "I ___ my hands before dinner.", answer: "wash", choices: ["wash","door","tall","cold"] },
    { type: "fill", sentence: "A cow gives us ___ .", answer: "milk", choices: ["milk","chair","happy","seven"] },
    { type: "fill", sentence: "The sun is bright in the ___ .", answer: "day", choices: ["day","read","warm","open"] },
    { type: "fill", sentence: "My brother likes to ___ pictures.", answer: "draw", choices: ["draw","cold","water","desk"] },
    { type: "fill", sentence: "We have four ___ in a year.", answer: "seasons", choices: ["seasons","pencils","chairs","doors"] }
  ],
  3: [
    { type: "fill", sentence: "My family will ___ to the beach this weekend.", answer: "travel", choices: ["travel","kitchen","yellow","between"] },
    { type: "fill", sentence: "She is good at ___ the piano.", answer: "playing", choices: ["playing","chair","seven","under"] },
    { type: "fill", sentence: "We should ___ the classroom after the party.", answer: "clean", choices: ["clean","apple","warm","story"] },
    { type: "fill", sentence: "I usually ___ up at seven in the morning.", answer: "wake", choices: ["wake","door","green","milk"] },
    { type: "fill", sentence: "The library is ___ to the school.", answer: "next", choices: ["next","cold","happy","fast"] },
    { type: "fill", sentence: "He wants to ___ a doctor when he grows up.", answer: "become", choices: ["become","pencil","bright","clean"] },
    { type: "fill", sentence: "Please ___ me the salt.", answer: "pass", choices: ["pass","warm","story","green"] },
    { type: "fill", sentence: "We learned about animals in ___ class.", answer: "science", choices: ["science","kitchen","umbrella","chair"] },
    { type: "fill", sentence: "I am ___ than my little brother.", answer: "taller", choices: ["taller","warmly","happily","quickly"] },
    { type: "fill", sentence: "The movie was so funny that we ___ a lot.", answer: "laughed", choices: ["laughed","cleaned","opened","closed"] },
    { type: "fill", sentence: "Can you ___ me with my homework?", answer: "help", choices: ["help","door","warm","milk"] },
    { type: "fill", sentence: "We take a ___ to school every day.", answer: "bus", choices: ["bus","story","green","clean"] },
    { type: "fill", sentence: "The weather is ___ today, so let's go outside.", answer: "sunny", choices: ["sunny","chair","seven","pencil"] },
    { type: "fill", sentence: "My hobby is ___ stamps.", answer: "collecting", choices: ["collecting","kitchen","warmly","between"] },
    { type: "fill", sentence: "She ___ her grandmother last Sunday.", answer: "visited", choices: ["visited","cleaned","jumped","opened"] },
    { type: "fill", sentence: "Wash your hands ___ you eat.", answer: "before", choices: ["before","warm","story","green"] },
    { type: "fill", sentence: "The train is faster ___ the bus.", answer: "than", choices: ["than","door","clean","milk"] },
    { type: "fill", sentence: "I want to ___ how to swim this summer.", answer: "learn", choices: ["learn","chair","seven","warm"] },
    { type: "fill", sentence: "There are many ___ in the zoo.", answer: "animals", choices: ["animals","kitchens","pencils","umbrellas"] },
    { type: "fill", sentence: "He ran ___ to catch the ball.", answer: "quickly", choices: ["quickly","chair","story","green"] }
  ],
  4: [
    { type: "fill", sentence: "If it rains tomorrow, we will ___ our trip.", answer: "cancel", choices: ["cancel","garden","quiet","between"] },
    { type: "fill", sentence: "She has been ___ English for three years.", answer: "studying", choices: ["studying","travel","become","quickly"] },
    { type: "fill", sentence: "The teacher asked us to ___ our ideas with the class.", answer: "share", choices: ["share","garden","sunny","quiet"] },
    { type: "fill", sentence: "I was so tired that I ___ asleep on the sofa.", answer: "fell", choices: ["fell","cleaned","learned","visited"] },
    { type: "fill", sentence: "We should ___ water to protect the environment.", answer: "save", choices: ["save","garden","quiet","sunny"] },
    { type: "fill", sentence: "He is the most ___ student in our class.", answer: "diligent", choices: ["diligent","garden","quickly","between"] },
    { type: "fill", sentence: "My sister and I ___ a room together.", answer: "share", choices: ["share","travel","become","quiet"] },
    { type: "fill", sentence: "The story was so ___ that I read it twice.", answer: "interesting", choices: ["interesting","garden","sunny","quiet"] },
    { type: "fill", sentence: "Could you ___ your opinion more clearly?", answer: "explain", choices: ["explain","garden","travel","sunny"] },
    { type: "fill", sentence: "We are planning to ___ a school festival next month.", answer: "hold", choices: ["hold","garden","quiet","become"] },
    { type: "fill", sentence: "Everyone should ___ the rules of the game.", answer: "follow", choices: ["follow","garden","sunny","quickly"] },
    { type: "fill", sentence: "The scientists made an important ___ .", answer: "discovery", choices: ["discovery","garden","travel","become"] },
    { type: "fill", sentence: "I need to ___ my mistake and try again.", answer: "correct", choices: ["correct","garden","quiet","sunny"] },
    { type: "fill", sentence: "She spoke ___ so that everyone could understand.", answer: "clearly", choices: ["clearly","garden","travel","become"] },
    { type: "fill", sentence: "We ___ a lot of information for our project.", answer: "gathered", choices: ["gathered","traveled","became","cleaned"] },
    { type: "fill", sentence: "The bridge ___ the two parts of the city.", answer: "connects", choices: ["connects","gardens","travels","becomes"] },
    { type: "fill", sentence: "He decided to ___ the club after school.", answer: "join", choices: ["join","garden","quiet","sunny"] },
    { type: "fill", sentence: "Reading books can ___ your vocabulary.", answer: "improve", choices: ["improve","garden","travel","become"] },
    { type: "fill", sentence: "They ___ the problem by working together.", answer: "solved", choices: ["solved","traveled","gardened","became"] },
    { type: "fill", sentence: "The nurse told him to ___ well and drink water.", answer: "rest", choices: ["rest","garden","travel","sunny"] }
  ],
  5: [
    { type: "fill", sentence: "Although he was nervous, he ___ gave a great speech.", answer: "still", choices: ["still","garden","quickly","between"] },
    { type: "fill", sentence: "The more you practice, the ___ you will become.", answer: "better", choices: ["better","garden","travel","sunny"] },
    { type: "fill", sentence: "She suggested that we ___ the meeting until Friday.", answer: "postpone", choices: ["postpone","garden","travel","become"] },
    { type: "fill", sentence: "Regular exercise can ___ your health.", answer: "benefit", choices: ["benefit","garden","travel","sunny"] },
    { type: "fill", sentence: "He apologized for the ___ he had caused.", answer: "trouble", choices: ["trouble","garden","travel","sunny"] },
    { type: "fill", sentence: "The experiment ___ that plants need sunlight.", answer: "proved", choices: ["proved","gardened","traveled","became"] },
    { type: "fill", sentence: "We need to ___ between the two plans carefully.", answer: "choose", choices: ["choose","garden","travel","sunny"] },
    { type: "fill", sentence: "The volunteers worked hard to ___ the community.", answer: "support", choices: ["support","garden","travel","sunny"] },
    { type: "fill", sentence: "His explanation was clear and easy to ___ .", answer: "understand", choices: ["understand","garden","travel","become"] },
    { type: "fill", sentence: "The company will ___ a new product next year.", answer: "release", choices: ["release","garden","travel","sunny"] },
    { type: "fill", sentence: "Despite the rain, the crowd remained ___ .", answer: "cheerful", choices: ["cheerful","garden","travel","sunny"] },
    { type: "fill", sentence: "You should ___ the instructions before you start.", answer: "review", choices: ["review","garden","travel","sunny"] },
    { type: "fill", sentence: "The bridge was ___ to allow bigger ships to pass.", answer: "raised", choices: ["raised","gardened","traveled","became"] },
    { type: "fill", sentence: "Her hard work finally ___ off with a prize.", answer: "paid", choices: ["paid","gardened","traveled","became"] },
    { type: "fill", sentence: "We should ___ the needs of others, not just our own.", answer: "consider", choices: ["consider","garden","travel","sunny"] },
    { type: "fill", sentence: "The recipe ___ two cups of flour.", answer: "requires", choices: ["requires","gardens","travels","becomes"] },
    { type: "fill", sentence: "He kept calm and ___ the difficult situation well.", answer: "handled", choices: ["handled","gardened","traveled","became"] },
    { type: "fill", sentence: "Their teamwork ___ the project a success.", answer: "made", choices: ["made","gardened","traveled","became"] },
    { type: "fill", sentence: "The article ___ the causes of climate change.", answer: "describes", choices: ["describes","gardens","travels","becomes"] },
    { type: "fill", sentence: "We must ___ our natural resources for the future.", answer: "protect", choices: ["protect","garden","travel","sunny"] }
  ],
  6: [
